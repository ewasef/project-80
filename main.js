...
function submit(){
    ...
    for (var e=1; e<=4; e++){
        var name_of_the_student=document.getElementById("name_of_the_student_"+e).value ;
    ...
    for (var s=0; s<length_of_the_name_of_the_student_array; s++){
...
function sorting(){
    ...
    length_of_the_name_of_the_student_array=name_of_the_student_array.length ;
    console.log(length_of_the_name_of_the_student_array) ;
    for (var s=0; s<length_of_the_name_of_the_student_array; s++){
